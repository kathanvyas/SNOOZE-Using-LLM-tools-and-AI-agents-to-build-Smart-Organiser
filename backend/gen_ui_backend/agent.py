...
from gen_ui_backend.utils.graphs.SuperGraph.nodes import detect_intent, route_from_call_tool, \
                                                        ...
                                                        search_agent, scheduler_router, email_summary_agent, email_summary_router, todo_agent, todo_router
...
def create_graph() -> CompiledGraph:
    ...
    workflow.add_node("email_summary_node", email_summary_agent)
    workflow.add_node("todo_node", todo_agent)
    ...
    workflow.add_conditional_edges(
        ...
        route_to_agent,
        {
            ...
            "email_summary_agent": "email_summary_node",
    ...
    workflow.add_conditional_edges(
        "email_summary_node",
        email_summary_router,
        {
            "continue": "email_summary_node",
            "call_tool": "tool_node",
            END: END,
        }
    )
    ...
    workflow.add_conditional_edges(
        ...
        route_from_call_tool,
        {
            ...
            "email_summary_node": "email_summary_node",
            "todo_node": "todo_node",
            "end": END
        }
    )
