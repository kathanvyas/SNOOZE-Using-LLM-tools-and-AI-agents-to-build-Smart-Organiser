...
todo_tools = composio_toolset.get_tools(
            actions=[Action.GOOGLETASKS_CREATE_TASK_LIST, 
                    Action.GOOGLETASKS_CLEAR_TASKS, 
                    Action.GOOGLETASKS_DELETE_TASK,
                    Action.GOOGLETASKS_DELETE_TASK_LIST,
                    Action.GOOGLETASKS_GET_TASK,
                    Action.GOOGLETASKS_GET_TASK_LIST,
                    Action.GOOGLETASKS_INSERT_TASK,
                    Action.GOOGLETASKS_LIST_TASKS,
                    Action.GOOGLETASKS_PATCH_TASK,
                    Action.GOOGLETASKS_LIST_TASK_LISTS,
                    Action.GOOGLETASKS_PATCH_TASK_LIST])
...
tools = [google_search_tool, *schedule_tools, *email_tools, *todo_tools]
